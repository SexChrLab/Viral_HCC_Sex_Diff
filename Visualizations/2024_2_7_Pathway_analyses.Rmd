...
write.csv(tumor_adjacent_HBV_uf_abbr, "~/3.0 Hasting Research/Liver Cancer Analysis/Gene lists/significant_HBV_HCV_opp_dir.csv")
```
...
write.csv(tumor_adjacent_HCV_uf_abbr[which(abs(tumor_adjacent_HCV_uf_abbr$logFC)>1),], "~/3.0 Hasting Research/Liver Cancer Analysis/Gene lists/Significant_HCV_only.csv")
```
