...
write.csv(tumor_adjacent_M_uf_abbr, "~/3.0 Hasting Research/Liver Cancer Analysis/Gene lists/significant_male_only.csv")

tumor_adjacent_M_uf_abbr <- tumor_adjacent_M_uf[which(tumor_adjacent_M_uf$adj.P.Val<0.05 & tumor_adjacent_F_uf$adj.P.Val>=0.05 & (tumor_adjacent_M_uf$logFC>1 | tumor_adjacent_M_uf$logFC< -1)),]
tumor_adjacent_F_uf_abbr <- tumor_adjacent_F_uf[which(tumor_adjacent_M_uf$adj.P.Val<0.05 & tumor_adjacent_F_uf$adj.P.Val>=0.05 & (tumor_adjacent_M_uf$logFC>1 | tumor_adjacent_M_uf$logFC< -1)),]
identical(tumor_adjacent_F_uf_abbr$GENEID, tumor_adjacent_M_uf_abbr$GENEID)
...
write.csv(tumor_adjacent_M_uf_abbr, "~/3.0 Hasting Research/Liver Cancer Analysis/Gene lists/significant_male_only_logFC1.csv")
```
...
write.csv(tumor_adjacent_M_uf_abbr, "~/3.0 Hasting Research/Liver Cancer Analysis/Gene lists/significant_female_only.csv")

tumor_adjacent_M_uf_abbr <- tumor_adjacent_M_uf[which(tumor_adjacent_M_uf$adj.P.Val>=0.05 & tumor_adjacent_F_uf$adj.P.Val<0.05 & (tumor_adjacent_F_uf$logFC>1 | tumor_adjacent_F_uf$logFC< -1)),]
tumor_adjacent_F_uf_abbr <- tumor_adjacent_F_uf[which(tumor_adjacent_M_uf$adj.P.Val>=0.05 & tumor_adjacent_F_uf$adj.P.Val<0.05 & (tumor_adjacent_F_uf$logFC>1 | tumor_adjacent_F_uf$logFC< -1)),]
identical(tumor_adjacent_F_uf_abbr$GENEID, tumor_adjacent_M_uf_abbr$GENEID)
...
write.csv(tumor_adjacent_M_uf_abbr, "~/3.0 Hasting Research/Liver Cancer Analysis/Gene lists/significant_female_only_logFC1.csv")
```
